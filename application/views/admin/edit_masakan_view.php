		...
		<div class="row">
			<form action="<?=base_url('index.php');?>/masakan/proses_edit" method="post">
				...
				<select name="status_masakan" class="form-control">
					<option value="ada" <?php if($list_masakan->status_masakan == 'ada'):?>selected <?php endif;?>>Masih</option>
					<option value="tidak_ada" <?php if($list_masakan->status_masakan == 'tidak_ada'):?>selected <?php endif;?>>Habis</option>
				</select>
				<br>

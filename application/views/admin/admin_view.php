<div class="panel panel-headline">
	...
	<div class="panel-body">
		<div class="row">
			<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-md"></span> Tambah Admin</button>
					...
					<?php
						...
						?>
							<tr>
								...
								<td>
									<a href="<?=base_url("index.php");?>/admin/edit_admin/<?=$admin->id_user;?>" class="btn btn-primary btn-sm">Ubah</a>

									<a href="<?=base_url("index.php");?>/admin/delete_admin/<?=$admin->id_user;?>" class="btn btn-danger btn-sm">Hapus</a>
								</td>
							</tr>
						<?php
						$no++;
